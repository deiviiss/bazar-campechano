...
import { getCategories, getUserSessionServer } from '@/actions'
import { getSellerProducts } from '@/actions/products/get-seller-products'
...
export default async function ProductsPage({ searchParams }: Props) {
  ...
  const { products, totalPages } = await getSellerProducts({ page, query, category: categoryName, userId: user.id })
